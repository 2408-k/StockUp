  ...
  return (
    <div>
      <Route exact path="/">
        <Link exact to="/login">
          {" "}
          <h4> Click here to go to Login Page</h4>{" "}
        </Link>
        <Link exact to="/stocksPage">
          {" "}
          <h4> Click here to go to Stocks Page </h4>{" "}
        </Link>
        <Link exact to="/signup">
          {" "}
          <h4> Click here to go to SignUp Page </h4>{" "}
        </Link>
        <Link exact to="/MyProfile">
          {" "}
          <h4> Click here to go to Profile Page </h4>{" "}
        </Link>
        <Link exact to="/MyWallet">
          {" "}
          <h4> Click here to go to Wallet Page</h4>{" "}
        </Link>
        <Link exact to="/AddMoney">
          {" "}
          <h4> Click here to go to Add Money</h4>{" "}
        </Link>
        <Link exact to="/RemoveMoney">
          {" "}
          <h4> Click here to go to Remove Money</h4>{" "}
        </Link>
      </Route>
